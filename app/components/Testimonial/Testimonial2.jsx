                        ...
                        <div className="col-lg-5">
                            ...
                            <div className="agk-image-box mb-50 pf_fadeup">
                                <div className="agk-image">
                                    <img src="/assets/images/digital-agency/testimonial/testimonial_img1.jpg" className="animated-image" alt="testimonial image" />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-7">
                            <div className="testimonial-wrapper mb-50 pf_fadeup">
                                ...
                                {testimonialContent.map((item, i) => (                                    
                                    <div key={i} className="pm-testimonial-item style-one">
