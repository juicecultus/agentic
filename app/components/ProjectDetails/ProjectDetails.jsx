...
const ProjectDetails = () => {
    return (
            <section class="agenko-project-details pt-130 pb-90">
                <div class="container">
                    <div class="project-details-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="agenko-image text-center mb-50 pf_fadeup">
                                    <img src="/assets/images/pages/project/project-single1.jpg" alt="project-single" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="project-duration-box pf_fadeup">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="agenko-info-box mb-30">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="agenko-content-box pf_fadeup">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="agenko-image mb-40">
                                                <img src="/assets/images/pages/project/project-single2.jpg" alt="project-single" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="agenko-image mb-40">
                                                <img src="/assets/images/pages/project/project-single3.jpg" alt="project-single" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
