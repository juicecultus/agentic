...
const ProjectDetails = () => {
    return (
            <section class="pm-project-details pt-130 pb-90">
                <div class="container">
                    <div class="project-details-wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="pm-image text-center mb-50 pf_fadeup">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="pm-content-box pf_fadeup">
