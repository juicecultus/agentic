...
const ProjectDetails = () => {
    return (
            <section className="pm-project-details pt-130 pb-90">
                <div className="container">
                    <div className="project-details-wrapper">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="pm-image text-center mb-50 pf_fadeup">
                                ...
                                <div className="project-duration-box pf_fadeup">
                                    <div className="row">
                                        <div className="col-sm-6">
                                            <div className="pm-info-box mb-30">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="pm-content-box pf_fadeup">
